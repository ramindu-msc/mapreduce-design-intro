package org.iit.mapreduce.patterns.topten;
...
public class TopTenUsersByReputation extends Configured implements Tool {
	...
	public static class TopTenMapper extends
		...
		public void map(Object key, Text value, Context context)
			...
			if (MRDPUtils.isNullOrEmpty(userId) || MRDPUtils.isNullOrEmpty(reputation)
					|| !MRDPUtils.isInteger(reputation) || MRDPUtils.isNullOrEmpty(displayName)) {
				return;
			}
